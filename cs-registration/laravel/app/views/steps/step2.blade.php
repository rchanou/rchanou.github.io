        ...
        <div class="row" style="margin-top: 10px;">
            <div class="col-sm-6">
                ...
                <div class="centered">
                    ...
                    <span class="requiredAsterisk">*</span><br/>{{ Form::text('firstname',Input::old('firstname',''),array('class'=>'required','maxlength'=>'50')) }}<p/>
                    @else
                    <br/>{{ Form::text('firstname',Input::old('firstname',''),array('maxlength'=>'50')) }}<p/>
                    @endif
                </div>
                @endif
            </div>
            <div class="col-sm-6">
                ...
                <div class="centered">
                    ...
                    <span class="requiredAsterisk">*</span><br/>{{ Form::text('lastname',Input::old('lastname',''),array('class'=>'required','maxlength'=>'50')) }}<p/>
                    @else
                    <br/>{{ Form::text('lastname',Input::old('lastname',''),array('maxlength'=>'50')) }}<p/>
                    @endif
                </div>
                @endif
            </div>
