...
var FadeOut = React.createClass({
	timeout: null,
	getDefaultProps (){
		return { rate: 0.01, delay: 3000, onFadeComplete (){}, fading: false };
	},
	getInitialState (){
		...
		return <div key='table'>
			<div>
				{this.state.requestCount > 0?
					loadingMessage
				: foundBookings.length + (foundBookings.length > 1? ' activities': ' activity') + ' found.'}<br/>
			</div>
