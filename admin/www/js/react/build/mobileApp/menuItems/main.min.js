...
},{}],"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\draggabilly\\draggabilly.js":[function(require,module,exports){
!function(t){"use strict";function e(t,e){for(var i in e)t[i]=e[i];return t}function i(){}function n(n,o,s,h,d){function c(t,i){this.element="string"==typeof t?r.querySelector(t):t,this.options=e({},this.options),e(this.options,i),this._create()}function l(){return!1}function g(t,e){t.x=void 0!==e.pageX?e.pageX:e.clientX,t.y=void 0!==e.pageY?e.pageY:e.clientY}function f(t,e,i){return i=i||"round",e?Math[i](t/e)*e:t}var y=h("transform"),v=!!h("perspective");e(c.prototype,o.prototype),c.prototype.options={},c.prototype._create=function(){this.position={},this._getPosition(),this.startPoint={x:0,y:0},this.dragPoint={x:0,y:0},this.startPosition=e({},this.position);var t=a(this.element);"relative"!==t.position&&"absolute"!==t.position&&(this.element.style.position="relative"),this.enable(),this.setHandles()},c.prototype.setHandles=function(){this.handles=this.options.handle?this.element.querySelectorAll(this.options.handle):[this.element];for(var e=0,i=this.handles.length;i>e;e++){var n=this.handles[e];t.navigator.pointerEnabled?(s.bind(n,"pointerdown",this),n.style.touchAction="none"):t.navigator.msPointerEnabled?(s.bind(n,"MSPointerDown",this),n.style.msTouchAction="none"):(s.bind(n,"mousedown",this),s.bind(n,"touchstart",this),P(n))}};var m="attachEvent"in r.documentElement,P=m?function(t){"IMG"===t.nodeName&&(t.ondragstart=l);for(var e=t.querySelectorAll("img"),i=0,n=e.length;n>i;i++){var o=e[i];o.ondragstart=l}}:i;c.prototype._getPosition=function(){var t=a(this.element),e=parseInt(t.left,10),i=parseInt(t.top,10);this.position.x=isNaN(e)?0:e,this.position.y=isNaN(i)?0:i,this._addTransformPosition(t)},c.prototype._addTransformPosition=function(t){if(y){var e=t[y];if(0===e.indexOf("matrix")){var i=e.split(","),n=0===e.indexOf("matrix3d")?12:4,o=parseInt(i[n],10),r=parseInt(i[n+1],10);this.position.x+=o,this.position.y+=r}}},c.prototype.handleEvent=function(t){var e="on"+t.type;this[e]&&this[e](t)},c.prototype.getTouch=function(t){for(var e=0,i=t.length;i>e;e++){var n=t[e];if(n.identifier===this.pointerIdentifier)return n}},c.prototype.onmousedown=function(t){var e=t.button;e&&0!==e&&1!==e||this.dragStart(t,t)},c.prototype.ontouchstart=function(t){this.isDragging||this.dragStart(t,t.changedTouches[0])},c.prototype.onMSPointerDown=c.prototype.onpointerdown=function(t){this.isDragging||this.dragStart(t,t)};var x={mousedown:["mousemove","mouseup"],touchstart:["touchmove","touchend","touchcancel"],pointerdown:["pointermove","pointerup","pointercancel"],MSPointerDown:["MSPointerMove","MSPointerUp","MSPointerCancel"]};c.prototype.dragStart=function(e,i){this.isEnabled&&(e.preventDefault?e.preventDefault():e.returnValue=!1,this.pointerIdentifier=void 0!==i.pointerId?i.pointerId:i.identifier,this._getPosition(),this.measureContainment(),g(this.startPoint,i),this.startPosition.x=this.position.x,this.startPosition.y=this.position.y,this.setLeftTop(),this.dragPoint.x=0,this.dragPoint.y=0,this._bindEvents({events:x[e.type],node:e.preventDefault?t:r}),n.add(this.element,"is-dragging"),this.isDragging=!0,this.emitEvent("dragStart",[this,e,i]),this.animate())},c.prototype._bindEvents=function(t){for(var e=0,i=t.events.length;i>e;e++){var n=t.events[e];s.bind(t.node,n,this)}this._boundEvents=t},c.prototype._unbindEvents=function(){var t=this._boundEvents;if(t&&t.events){for(var e=0,i=t.events.length;i>e;e++){var n=t.events[e];s.unbind(t.node,n,this)}delete this._boundEvents}},c.prototype.measureContainment=function(){var t=this.options.containment;if(t){this.size=d(this.element);var e=this.element.getBoundingClientRect(),i=p(t)?t:"string"==typeof t?r.querySelector(t):this.element.parentNode;this.containerSize=d(i);var n=i.getBoundingClientRect();this.relativeStartPosition={x:e.left-n.left,y:e.top-n.top}}},c.prototype.onmousemove=function(t){this.dragMove(t,t)},c.prototype.onMSPointerMove=c.prototype.onpointermove=function(t){t.pointerId===this.pointerIdentifier&&this.dragMove(t,t)},c.prototype.ontouchmove=function(t){var e=this.getTouch(t.changedTouches);e&&this.dragMove(t,e)},c.prototype.dragMove=function(t,e){g(this.dragPoint,e);var i=this.dragPoint.x-this.startPoint.x,n=this.dragPoint.y-this.startPoint.y,o=this.options.grid,r=o&&o[0],s=o&&o[1];i=f(i,r),n=f(n,s),i=this.containDrag("x",i,r),n=this.containDrag("y",n,s),i="y"===this.options.axis?0:i,n="x"===this.options.axis?0:n,this.position.x=this.startPosition.x+i,this.position.y=this.startPosition.y+n,this.dragPoint.x=i,this.dragPoint.y=n,this.emitEvent("dragMove",[this,t,e])},c.prototype.containDrag=function(t,e,i){if(!this.options.containment)return e;var n="x"===t?"width":"height",o=this.relativeStartPosition[t],r=f(-o,i,"ceil"),s=this.containerSize[n]-o-this.size[n];return s=f(s,i,"floor"),Math.min(s,Math.max(r,e))},c.prototype.onmouseup=function(t){this.dragEnd(t,t)},c.prototype.onMSPointerUp=c.prototype.onpointerup=function(t){t.pointerId===this.pointerIdentifier&&this.dragEnd(t,t)},c.prototype.ontouchend=function(t){var e=this.getTouch(t.changedTouches);e&&this.dragEnd(t,e)},c.prototype.dragEnd=function(t,e){this.isDragging=!1,delete this.pointerIdentifier,y&&(this.element.style[y]="",this.setLeftTop()),this._unbindEvents(),n.remove(this.element,"is-dragging"),this.emitEvent("dragEnd",[this,t,e])},c.prototype.onMSPointerCancel=c.prototype.onpointercancel=function(t){t.pointerId===this.pointerIdentifier&&this.dragEnd(t,t)},c.prototype.ontouchcancel=function(t){var e=this.getTouch(t.changedTouches);this.dragEnd(t,e)},c.prototype.animate=function(){if(this.isDragging){this.positionDrag();var t=this;u(function(){t.animate()})}};var E=v?function(t,e){return"translate3d( "+t+"px, "+e+"px, 0)"}:function(t,e){return"translate( "+t+"px, "+e+"px)"};return c.prototype.setLeftTop=function(){this.element.style.left=this.position.x+"px",this.element.style.top=this.position.y+"px"},c.prototype.positionDrag=y?function(){this.element.style[y]=E(this.dragPoint.x,this.dragPoint.y)}:c.prototype.setLeftTop,c.prototype.enable=function(){this.isEnabled=!0},c.prototype.disable=function(){this.isEnabled=!1,this.isDragging&&this.dragEnd()},c}for(var o,r=t.document,s=r.defaultView,a=s&&s.getComputedStyle?function(t){return s.getComputedStyle(t,null)}:function(t){return t.currentStyle},p="object"==typeof HTMLElement?function(t){return t instanceof HTMLElement}:function(t){return t&&"object"==typeof t&&1===t.nodeType&&"string"==typeof t.nodeName},h=0,d="webkit moz ms o".split(" "),u=t.requestAnimationFrame,c=t.cancelAnimationFrame,l=0;l<d.length&&(!u||!c);l++)o=d[l],u=u||t[o+"RequestAnimationFrame"],c=c||t[o+"CancelAnimationFrame"]||t[o+"CancelRequestAnimationFrame"];u&&c||(u=function(e){var i=(new Date).getTime(),n=Math.max(0,16-(i-h)),o=t.setTimeout(function(){e(i+n)},n);return h=i+n,o},c=function(e){t.clearTimeout(e)}),"function"==typeof define&&define.amd?define(["classie/classie","eventEmitter/EventEmitter","eventie/eventie","get-style-property/get-style-property","get-size/get-size"],n):"object"==typeof exports?module.exports=n(require("desandro-classie"),require("wolfy87-eventemitter"),require("eventie"),require("desandro-get-style-property"),require("get-size")):t.Draggabilly=n(t.classie,t.EventEmitter,t.eventie,t.getStyleProperty,t.getSize)}(window);
},{"desandro-classie":"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\draggabilly\\node_modules\\desandro-classie\\classie.js","desandro-get-style-property":"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\draggabilly\\node_modules\\desandro-get-style-property\\get-style-property.js","eventie":"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\draggabilly\\node_modules\\eventie\\eventie.js","get-size":"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\draggabilly\\node_modules\\get-size\\get-size.js","wolfy87-eventemitter":"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\draggabilly\\node_modules\\wolfy87-eventemitter\\EventEmitter.js"}],"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\draggabilly\\node_modules\\desandro-classie\\classie.js":[function(require,module,exports){
!function(s){"use strict";function e(s){return new RegExp("(^|\\s+)"+s+"(\\s+|$)")}function n(s,e){var n=t(s,e)?c:a;n(s,e)}var t,a,c;"classList"in document.documentElement?(t=function(s,e){return s.classList.contains(e)},a=function(s,e){s.classList.add(e)},c=function(s,e){s.classList.remove(e)}):(t=function(s,n){return e(n).test(s.className)},a=function(s,e){t(s,e)||(s.className=s.className+" "+e)},c=function(s,n){s.className=s.className.replace(e(n)," ")});var o={hasClass:t,addClass:a,removeClass:c,toggleClass:n,has:t,add:a,remove:c,toggle:n};"function"==typeof define&&define.amd?define(o):"object"==typeof exports?module.exports=o:s.classie=o}(window);
},{}],"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\draggabilly\\node_modules\\desandro-get-style-property\\get-style-property.js":[function(require,module,exports){
...
!function(t){"use strict";function e(t){var e=parseFloat(t),r=-1===t.indexOf("%")&&!isNaN(e);return r&&e}function r(){for(var t={width:0,height:0,innerWidth:0,innerHeight:0,outerWidth:0,outerHeight:0},e=0,r=o.length;r>e;e++){var i=o[e];t[i]=0}return t}function i(i){function d(){if(!u){u=!0;var r=t.getComputedStyle;if(a=function(){var t=r?function(t){return r(t,null)}:function(t){return t.currentStyle};return function(e){var r=t(e);return r||n("Style returned "+r+". Are you running this code in a hidden iframe on Firefox? See http://bit.ly/getsizeiframe"),r}}(),p=i("boxSizing")){var o=document.createElement("div");o.style.width="200px",o.style.padding="1px 2px 3px 4px",o.style.borderStyle="solid",o.style.borderWidth="1px 2px 3px 4px",o.style[p]="border-box";var d=document.body||document.documentElement;d.appendChild(o);var f=a(o);g=200===e(f.width),d.removeChild(o)}}}function f(t){if(d(),"string"==typeof t&&(t=document.querySelector(t)),t&&"object"==typeof t&&t.nodeType){var i=a(t);if("none"===i.display)return r();var n={};n.width=t.offsetWidth,n.height=t.offsetHeight;for(var f=n.isBorderBox=!(!p||!i[p]||"border-box"!==i[p]),u=0,l=o.length;l>u;u++){var y=o[u],m=i[y];m=h(t,m);var c=parseFloat(m);n[y]=isNaN(c)?0:c}var s=n.paddingLeft+n.paddingRight,v=n.paddingTop+n.paddingBottom,b=n.marginLeft+n.marginRight,x=n.marginTop+n.marginBottom,W=n.borderLeftWidth+n.borderRightWidth,S=n.borderTopWidth+n.borderBottomWidth,w=f&&g,B=e(i.width);B!==!1&&(n.width=B+(w?0:s+W));var L=e(i.height);return L!==!1&&(n.height=L+(w?0:v+S)),n.innerWidth=n.width-(s+W),n.innerHeight=n.height-(v+S),n.outerWidth=n.width+b,n.outerHeight=n.height+x,n}}function h(t,e){if(getComputedStyle||-1===e.indexOf("%"))return e;var r=t.style,i=r.left,n=t.runtimeStyle,o=n&&n.left;return o&&(n.left=t.currentStyle.left),r.left=e,e=r.pixelLeft,r.left=i,o&&(n.left=o),e}var a,p,g,u=!1;return f}var n="undefined"==typeof console?noop:function(t){console.error(t)},o=["paddingLeft","paddingRight","paddingTop","paddingBottom","marginLeft","marginRight","marginTop","marginBottom","borderLeftWidth","borderRightWidth","borderTopWidth","borderBottomWidth"];"function"==typeof define&&define.amd?define(["get-style-property/get-style-property"],i):"object"==typeof exports?module.exports=i(require("desandro-get-style-property")):t.getSize=i(t.getStyleProperty)}(window);
},{"desandro-get-style-property":"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\draggabilly\\node_modules\\desandro-get-style-property\\get-style-property.js"}],"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\draggabilly\\node_modules\\wolfy87-eventemitter\\EventEmitter.js":[function(require,module,exports){
...
},{"./emptyFunction":"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\react\\lib\\emptyFunction.js","_process":"c:\\Users\\ronnie\\AppData\\Roaming\\npm\\node_modules\\watchify\\node_modules\\browserify\\node_modules\\process\\browser.js"}],"c:\\xampp\\htdocs\\admin\\www\\js\\react\\src\\components\\popup.js":[function(require,module,exports){
"use strict";var React=require("react/addons"),FadeOut=React.createClass({displayName:"FadeOut",timeout:null,getDefaultProps:function(){return{rate:.01,delay:3e3,onFadeComplete:function(){},onClick:function(){}}},getInitialState:function(){return{fading:!1,opacity:1}},render:function(){var t=this.props.style?{$merge:{opacity:this.state.opacity}}:{$set:{opacity:this.state.opacity}},e=React.addons.update(this.props,{style:t});return React.createElement(this.props.element||"div",e,this.props.children)},componentDidMount:function(){this.resetTimeout(),"undefined"!=typeof jQuery&&$(this.getDOMNode()).tooltip({title:"Click to dismiss.",placement:"bottom"})},resetTimeout:function(){this.timeout&&clearTimeout(this.timeout),-1!==this.props.className.indexOf("alert-success")&&(console.log("success"),this.timeout=setTimeout(function(){this.isMounted()&&this.setState({fading:!0})}.bind(this),this.props.delay))},componentDidUpdate:function(t){-1!==this.props.className.indexOf("alert-danger")&&-1===t.className.indexOf("alert-danger")||-1!==this.props.className.indexOf("alert-warning")&&-1===t.className.indexOf("alert-warning")?this.setState(this.getInitialState()):this.state.fading&&(this.state.opacity<=0?this.props.onFadeComplete(this.props):requestAnimationFrame(function(){this.isMounted()&&this.setState({opacity:this.state.opacity-this.props.rate})}.bind(this)))},componentWillUnmount:function(){"undefined"!=typeof jQuery&&$(this.getDOMNode()).tooltip("destroy")}}),Popup=React.createClass({displayName:"Popup",getDefaultProps:function(){return{message:"Something happened!",alertClass:"alert-info",onClick:function(){},onFadeComplete:function(){},onDone:function(){}}},render:function(){var t=this.props,e=(t.element,t.alertClass,t.message,function(t,e){var s={},i=Object.prototype.hasOwnProperty;if(null==t)throw new TypeError;for(var n in t)i.call(t,n)&&!i.call(e,n)&&(s[n]=t[n]);return s}(t,{element:1,alertClass:1,message:1}));return React.createElement(FadeOut,React.__spread({element:"div",onFadeComplete:this.handleComplete,onClick:this.handleClick,style:{position:"fixed",top:0,left:0,width:"100%",cursor:"pointer",zIndex:9999,textAlign:"center"},className:"alert "+this.props.alertClass,dangerouslySetInnerHTML:{__html:this.props.message}},e))},handleClick:function(t){this.props.onClick(t),this.props.onDone(t)},handleComplete:function(t){this.props.onFadeComplete(t),this.props.onDone(t)}});module.exports=Popup;
//# sourceMappingURL=out.js.map

},{"react/addons":"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\react\\addons.js"}],"c:\\xampp\\htdocs\\admin\\www\\js\\react\\src\\components\\react-transition.js":[function(require,module,exports){
"use strict";var React=require("react/addons"),d3=require("d3"),_=require("lodash"),ReactTransition=React.createClass({displayName:"ReactTransition",getDefaultProps:function(){return{ease:"cubic-out",duration:400,bypass:!1}},startAnimation:function(){function t(){if(!a&&!o.stopAnimation){var n=e();n>1&&(n=1,a=!0),o.animate(n),window.requestAnimationFrame(t)}}function e(){var t=(new Date).getTime();return(t-n)/(i-n)||0}var n=(new Date).getTime(),i=n+parseInt(this.props.duration,10),a=!1,o=this;t()},componentWillUnmount:function(){this.stopAnimation=!0},getInitialState:function(){return this.props},componentWillReceiveProps:function(t){if(t.bypass){var e=_.pick(t,function(t,e){return!("component"===e||"children"===e||"ease"===e||"duration"===e||e.match(/^on(.+)/))});this.setState(e)}else{var n=this,i={};_(t).each(function(e,a){"component"===a||"children"===a||"ease"===a||"duration"===a||a.match(/^on(.+)/)||(i[a]=d3.interpolate(n.state[a],t[a]))}),this.interpolators=i,this.startAnimation()}},animate:function(t){var e={},n=d3.ease(this.props.ease);_(this.interpolators).each(function(i,a){e[a]=i(n(t))}),this.setState(e)},render:function(){return React.createElement(this.props.component||"div",this.state,this.props.children)}});module.exports=ReactTransition;
//# sourceMappingURL=out.js.map

},{"d3":"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\d3\\d3.js","lodash":"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\lodash\\dist\\lodash.js","react/addons":"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\react\\addons.js"}],"c:\\xampp\\htdocs\\admin\\www\\js\\react\\src\\mobileApp\\menuItems\\main.js":[function(require,module,exports){
"use strict";var React=require("react/addons"),MenuItemEditor=require("./menu-item-editor");$(document).ready(function(){React.render(React.createElement(MenuItemEditor,{config:config}),document.getElementById("main"))});
//# sourceMappingURL=out.js.map

},{"./menu-item-editor":"c:\\xampp\\htdocs\\admin\\www\\js\\react\\src\\mobileApp\\menuItems\\menu-item-editor.js","react/addons":"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\react\\addons.js"}],"c:\\xampp\\htdocs\\admin\\www\\js\\react\\src\\mobileApp\\menuItems\\menu-item-editor.js":[function(require,module,exports){
"use strict";var React=require("react/addons"),Anim=require("../../components/react-transition"),Draggabilly=require("draggabilly"),_=require("lodash"),Popup=require("../../components/popup"),Draggable=React.createClass({displayName:"Draggable",draggie:null,render:function(){return React.createElement(this.props.element||"div",this.getElementProps(),this.props.children)},getElementProps:function(){var e=this.props,t=(e.element,e.children,function(e,t){var s={},n=Object.prototype.hasOwnProperty;if(null==e)throw new TypeError;for(var a in e)n.call(e,a)&&!n.call(t,a)&&(s[a]=e[a]);return s}(e,{element:1,children:1}));return t},componentDidMount:function(){this.draggie=new Draggabilly(this.getDOMNode(),this.props.options);for(var e in this.props.events)this.draggie.on(e,this.props.events[e])},componentWillUnmount:function(){this.draggie=null}}),TextRect=React.createClass({displayName:"TextRect",render:function(){return React.createElement("g",null,React.createElement("rect",React.__spread({x:this.props.x,y:this.props.y},this.props.rect)),React.createElement("text",React.__spread({x:this.props.x,y:this.props.y},this.props.text),this.props.children))}}),PreviewItem=React.createClass({displayName:"PreviewItem",getDefaultProps:function(){return{index:null,scale:40,spacerFactor:.1,text:"",dragX:null,dragY:null,onDragStart:function(){}}},render:function(){var e,t,s,n=this.props.scale;return e=null!==this.props.dragX?this.props.dragX:this.props.spacerFactor*n,null!==this.props.dragY?(t=this.props.dragY,s=this.props.dragY+n-this.props.spacerFactor):(t=(this.props.index+this.props.spacerFactor)*n,s=(this.props.index+1-this.props.spacerFactor)*n),React.createElement("g",{onMouseDown:this.handleMouseDown},React.createElement(Anim,{component:"rect",bypass:null!==this.props.dragX||null!==this.props.dragY,x:e,y:t,height:(1-this.props.spacerFactor)*n,width:10*n,rx:2,ry:2,stroke:"hsl(180,50%,30%)",strokeWidth:2,fill:"hsl(180,50%,80%)"}),React.createElement(Anim,{component:"text",bypass:null!==this.props.dragX||null!==this.props.dragY,x:e,y:s},this.props.text))},handleMouseDown:function(e){e.preventDefault(),this.props.onDragStart({id:this.props.index,x:null,y:(this.props.index+this.props.spacerFactor)*this.props.scale})}}),MenuItem=React.createClass({displayName:"MenuItem",propTypes:{pos:React.PropTypes.number,label:React.PropTypes.string,url:React.PropTypes.string,id:React.PropTypes.string,iconUrl:React.PropTypes.string,onEvent:React.PropTypes.func},getDefaultProps:function(){return{pos:null,label:"",url:"",id:"",iconUrl:"",onEvent:function(){}}},getInitialState:function(){return this.getStateFromProps(this.props)},getStateFromProps:function(e){var t={};for(var s in e)_.isFunction(e[s])||(t[s]=e[s]);return t},render:function(){return React.createElement("li",null,React.createElement("input",{defaultValue:this.props.label,ref:"label",onChange:this.handleChange}),React.createElement("input",{defaultValue:this.props.url,ref:"url",onChange:this.handleChange}),React.createElement("input",{defaultValue:this.props.iconUrl,ref:"iconUrl",onChange:this.handleChange}),React.createElement("button",{className:"btn btn-info",onClick:this.handleUpClick,disabled:0===this.props.pos},React.createElement("i",{className:"fa fa-chevron-up"})),React.createElement("button",{className:"btn btn-info",onClick:this.handleDownClick,disabled:this.props.pos>=this.props.containerLength-1},React.createElement("i",{className:"fa fa-chevron-down"})))},handleChange:function(){var e={};for(var t in this.state)e[t]="undefined"!=typeof this.refs[t]?this.refs[t].getDOMNode().value:this.state[t];this.setState(e),this.props.onEvent({type:"change",changedItem:e})},handleUpClick:function(e){e.preventDefault(),this.props.onEvent({item:this.state,type:"upClick"})},handleDownClick:function(e){e.preventDefault(),this.props.onEvent({item:this.state,type:"downClick"})},componentWillReceiveProps:function(e){this.setState(this.getStateFromProps(e))},componentDidUpdate:function(){for(var e in this.refs)this.refs[e].getDOMNode()!==document.activeElement&&(this.refs[e].getDOMNode().value=this.state[e])}}),MenuItemEditor=React.createClass({displayName:"MenuItemEditor",getDefaultProps:function(){return{scale:40,spacerFactor:.1}},getInitialState:function(){return{menuItems:[],dragItem:{id:null,x:null,y:null},left:0,settingsId:null,popup:{message:"",alertClass:null}}},render:function(){return React.createElement("div",null,React.createElement(Popup,React.__spread({},this.state.popup,{key:this.state.popup.message,onDone:this.handlePopupDone})),this.renderPreview(),this.renderForm())},renderPreview:function(){var e=this.props.scale,t=this.state.menuItems.map(function(e,t){var s={key:e.originalPos,index:t,scale:this.props.scale,spacerFactor:this.props.spacerFactor,text:e.label};return this.state.dragItem.id===e.originalPos?React.createElement(PreviewItem,React.__spread({},s,{dragX:this.state.dragItem.x,dragY:this.state.dragItem.y})):React.createElement(PreviewItem,React.__spread({},s,{onDragStart:this.handleItemDragStart}))}.bind(this));return React.createElement("div",null,React.createElement("h3",null,"Preview"),React.createElement("svg",{ref:"preview",height:(this.state.menuItems.length+2*this.props.spacerFactor)*e,width:"100%"},t))},renderForm:function(){var e=this.state.menuItems.map(function(e,t){return React.createElement(MenuItem,React.__spread({},e,{key:e.originalPos,pos:t,containerLength:this.state.menuItems.length,onEvent:this.handleItemEvent}))}.bind(this));return React.createElement("form",null,React.createElement("ol",{className:"widget-box"},e),React.createElement("input",{type:"submit",className:"btn btn-info",onClick:this.handleSubmit}))},mouseUpCallback:null,mouseMoveCallback:null,componentDidMount:function(){this.loadMenuItems(),console.log("window",window),window.onmouseup=function(){console.log("mouse up!"),this.setState({dragItem:{id:null}})}.bind(this),window.onmousemove=function(e){null!==this.state.dragItem.id&&this.setState({dragItem:{id:this.state.dragItem.id,x:null,y:this.calcDragOffsetY(e.y)}})}.bind(this)},calcDragOffsetY:function(e){var t=this.state.dragItem.id*this.props.scale;return e-t},componentDidUpdate:function(){},loadMenuItems:function(){$.get("https://192.168.111.122/api/index.php/settings.json?namespace=mobileApp&name=menuItems&key=cs-dev").then(function(e){var t=e.settings[0].settingsId,s=JSON.parse(e.settings[0].value).menuItems;s.forEach(function(e,t){e.originalPos=t}),this.setState({settingsId:t,menuItems:s})}.bind(this))},handleItemEvent:function(e){switch(e.type){case"change":var t={};t[e.changedItem.pos]={$set:e.changedItem};var s=React.addons.update(this.state.menuItems,t);this.setState({menuItems:s});break;case"upClick":if(e.item.pos>0){var t={};t[e.item.pos]={$set:this.state.menuItems[e.item.pos-1]},t[e.item.pos-1]={$set:this.state.menuItems[e.item.pos]};var s=React.addons.update(this.state.menuItems,t);this.setState({menuItems:s})}break;case"downClick":if(e.item.pos<this.state.menuItems.length-1){var t={};t[e.item.pos]={$set:this.state.menuItems[e.item.pos+1]},t[e.item.pos+1]={$set:this.state.menuItems[e.item.pos]};var s=React.addons.update(this.state.menuItems,t);this.setState({menuItems:s})}}},componentWillUnmount:function(){mouseUpCallback=null,mouseMoveCallback=null},handleSubmit:function(e){e.preventDefault();var t=["label","id","url","iconUrl"],s="https://192.168.111.122/api/index.php/settings/"+this.state.settingsId+"?key=cs-dev",n=JSON.stringify({menuItems:_.map(this.state.menuItems,function(e){return _.pick(e,t)})}),a={type:"PUT",url:s,data:{value:n}};$.ajax(a).then(function(){Array.prototype.slice.call(arguments,0);this.setState({popup:{message:"success",alertClass:"alert-success"}})}.bind(this))},handlePopupDone:function(){this.setState({popup:{message:null,alertClass:null}})},handleItemDragStart:function(e){console.log("drag start handled",e),this.setState({dragItem:e})}});module.exports=MenuItemEditor;
//# sourceMappingURL=out.js.map

},{"../../components/popup":"c:\\xampp\\htdocs\\admin\\www\\js\\react\\src\\components\\popup.js","../../components/react-transition":"c:\\xampp\\htdocs\\admin\\www\\js\\react\\src\\components\\react-transition.js","draggabilly":"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\draggabilly\\draggabilly.js","lodash":"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\lodash\\dist\\lodash.js","react/addons":"c:\\xampp\\htdocs\\admin\\www\\js\\react\\node_modules\\react\\addons.js"}]},{},["c:\\xampp\\htdocs\\admin\\www\\js\\react\\src\\mobileApp\\menuItems\\main.js"]);
