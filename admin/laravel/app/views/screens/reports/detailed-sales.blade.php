...
<a href="#" class="current">Detailed Sales</a>
@stop
       ...
       <div class="col-sm-10">
        <div class="widget-box">
          ...
          <div class="widget-content">
              <div class="row">
              {{ Form::open(array('action'=>'DetailedSalesReportController@index','files'=>false, 'class' => 'form-horizontal', 'id' => 'dateForm')) }}
                <div class="col-12-sm">
            ...
            <div class="widget-box">
              <div class="widget-title">
                ...
                @if(isset($start) && isset($end) && $start != "" && $end != "")
                    <h5>Detailed Sales Report - From {{$start}} to {{$end}} ({{$show_by_opened_date == 'true' ? 'By Opened Date' : 'By Closing Date'}})</h5>
                @elseif (isset($start) && $start != "")
                    <h5>Detailed Sales Report - {{$start}} ({{$show_by_opened_date == 'true' ? 'By Opened Date' : 'By Closing Date'}})</h5>
                @else
                    <h5>Detailed Sales Report - Today ({{$show_by_opened_date == 'true' ? 'By Opened Date' : 'By Closing Date'}})</h5>
                @endif
