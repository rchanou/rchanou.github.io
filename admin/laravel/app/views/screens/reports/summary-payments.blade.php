...
<a href="#" class="current">Summary Payments</a>
@stop
       ...
       <div class="col-sm-8">
        <div class="widget-box">
          ...
          <div class="widget-content">
              ...
              {{ Form::open(array('action'=>'SummaryPaymentsReportController@index','files'=>false, 'class' => 'form-horizontal', 'id' => 'dateForm')) }}
                <div class="col-12-sm">
            ...
            <div class="widget-box">
              <div class="widget-title">
                ...
                @if(isset($start) && isset($end) && $start != "" && $end != "")
                    <h5>Summary Payments Report - From {{$start}} to {{$end}}</h5>
                @elseif (isset($start) && $start != "")
                    <h5>Summary Payments Report - {{$start}}</h5>
                @else
                    <h5>Summary Payments Report - Today</h5>
                @endif
                <span class="icon pull-right" style="font-size: 12px; line-height: 12px;">
                    <a href="{{URL::to('reports/summary-payments/export/csv')}}"><button type="button">Export to CSV</button></a>
                </span>
              </div>
              <div class="widget-content">
                  <div class="row">
