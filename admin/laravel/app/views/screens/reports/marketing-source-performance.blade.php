...
<a href="#" class="current">Marketing Source Performance</a>
@stop
       ...
       <div class="col-sm-10">
        <div class="widget-box">
          ...
          <div class="widget-content">
              <div class="row">
              {{ Form::open(array('action'=>'MarketingSourcePerformanceReportController@index','files'=>false, 'class' => 'form-horizontal', 'id' => 'dateForm')) }}
                <div class="col-12-sm">
                    <table class="table table-bordered table-striped table-hover text-center">
                      ...
                      <tbody>
                        <tr>
                            ...
                            <td>
                                {{Form::select('show_by_opened_date',
                                    array(
                                             'false' => 'Check Closing Date',
                                             'true' => 'Check Opened Date'
                                         )
                                    ,
                                    $show_by_opened_date
                                )}}
            ...
            <div class="widget-box">
              <div class="widget-title">
                ...
                @if(isset($start) && isset($end) && $start != "" && $end != "")
                    <h5>Marketing Source Performance Report - From {{$start}} to {{$end}} ({{$show_by_opened_date == 'true' ? 'By Opened Date' : 'By Closing Date'}})</h5>
                @elseif (isset($start) && $start != "")
                    <h5>Marketing Source Performance Report - {{$start}} ({{$show_by_opened_date == 'true' ? 'By Opened Date' : 'By Closing Date'}})</h5>
                @else
                    <h5>Marketing Source Performance Report - Today ({{$show_by_opened_date == 'true' ? 'By Opened Date' : 'By Closing Date'}})</h5>
                @endif
                <span class="icon pull-right" style="font-size: 12px; line-height: 12px;">
                    <a href="{{URL::to('reports/marketing-source-performance/export/csv')}}"><button type="button">Export to CSV</button></a>
                </span>
              </div>
              <div class="widget-content">
