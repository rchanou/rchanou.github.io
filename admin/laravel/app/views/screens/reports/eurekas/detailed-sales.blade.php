...
<a href="#" class="current">Detailed Sales - Eurekas</a>
@stop
       ...
       <div class="col-sm-10">
        <div class="widget-box">
          ...
          <div class="widget-content">
              <div class="row">
              {{ Form::open(array('action'=>'EurekasDetailedSalesReportController@index','files'=>false, 'class' => 'form-horizontal', 'id' => 'dateForm')) }}
                <div class="col-12-sm">
            ...
            <div class="widget-box">
              <div class="widget-title">
                ...
                @if(isset($start) && isset($end) && $start != "" && $end != "")
                    <h5>Detailed Sales Report - Eurekas - From {{$start}} to {{$end}} ({{$show_by_opened_date == 'true' ? 'By Opened Date' : 'By Closing Date'}})</h5>
                @elseif (isset($start) && $start != "")
                    <h5>Detailed Sales Report - Eurekas - {{$start}} ({{$show_by_opened_date == 'true' ? 'By Opened Date' : 'By Closing Date'}})</h5>
                @else
                    <h5>Detailed Sales Report - Eurekas - Today ({{$show_by_opened_date == 'true' ? 'By Opened Date' : 'By Closing Date'}})</h5>
                @endif
                <span class="icon pull-right" style="font-size: 12px; line-height: 12px;">
                    <a href="{{URL::to('reports/eurekas-detailed-sales/export/csv')}}"><button type="button">Export to CSV</button></a>
                </span>
              </div>
              <div class="widget-content">
