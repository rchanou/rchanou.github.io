...
<a href="#" class="current">Transaction History Report</a>
@stop
       ...
       <div class="col-sm-8">
        <div class="widget-box">
          ...
          <div class="widget-content">
              <div class="row">
              {{ Form::open(array('action'=>'GiftCardsController@getTransactionReport','files'=>false, 'class' => 'form-horizontal')) }}
                <div class="col-12-sm">
            ...
            <div class="widget-box">
              <div class="widget-title">
                ...
                <span class="icon pull-right" style="font-size: 12px; line-height: 12px;">
                    <a href="{{URL::to('giftcards/reports/transactions/csv')}}"><button type="button">Export to CSV</button></a>
                </span>
              </div>
              <div class="widget-content">
