...
/**
 * UNPROTECTED routes (public, do not have to login)
 */
...
/**
 * PROTECTED routes (must login AND have permissions, uses "auth" and "validatePermission" in filter.php)
 */
...
Route::group(array('before' => 'auth'), function()
{
	...
	Route::get('speedScreen/translations', 'ChannelController@translations');
	Route::post('speedScreen/translations', 'ChannelController@updateTranslations');
  Route::post('speedScreen/updateSettings','ChannelController@updateSettings');
	...
	Route::get('booking/logs', 'BookingController@logs');
	Route::get('booking/logs/data', 'BookingController@data');
	...
	Route::get('reports/brokers-summary', 'BrokersSummaryReportController@index');
	Route::post('reports/brokers-summary', 'BrokersSummaryReportController@index');
	Route::get('reports/brokers-summary/export/csv', 'BrokersSummaryReportController@exportToCSV');

	Route::get('reports/logs', 'LogsController@index');
	...
	Route::get('reports/emv/configuration/{terminal}', 'EMVReportController@configuration');
	Route::get('reports/emv/chip/{terminal}', 'EMVReportController@chip');

	/* Facebook */
	Route::get('facebook', 'FacebookController@afterRaceSettings');
	Route::get('facebook/after-race-settings', 'FacebookController@afterRaceSettings');
	Route::post('facebook/after-race-settings/update', 'FacebookController@updateAfterRaceSettings');
	Route::get('facebook/logs', 'FacebookController@logs');
	Route::get('facebook/logs/data', 'FacebookController@data');
	Route::get('facebook/log-entries', 'FacebookController@logEntries');


	/* SpeedText */
	Route::get('speedtext', 'SpeedTextController@settings');
	Route::get('speedtext/settings', 'SpeedTextController@settings');
	Route::post('speedtext/settings/update', 'SpeedTextController@updateSettings');
	Route::get('speedtext/logs', 'SpeedTextController@logs');
	Route::get('speedtext/logs/data', 'SpeedTextController@data');
