...
<div class="mainBodyContent">
    ...
    <div class="checkoutForm" id="checkoutForm">
        <form id="checkoutAndPaymentForm" action="pay" method="POST">
            ...
            <input maxlength="255" type="text" id="number" name="number" class="required" style="margin-top: 5px;"><br/>
            ...
            <input maxlength="4" type="text" id="cvv" name="cvv" class="required smallerFormInput" style="margin-top: 5px;"><br/>
            ...
            <input maxlength="2" type="text" id="expiryMonth" name="expiryMonth" class="required monthInput" placeholder="MM" style="margin-top: 5px;"><br/>
            <label for="expiryYear">
                <strong>
                    {{$strings['str_expirationYear']}}: <span class="requiredAsterisk">*</span>
                </strong>
            </label>
            <input maxlength="4" type="text" id="expiryYear" name="expiryYear" class="required smallerFormInput" placeholder="YYYY" style="margin-top: 5px;"><br/>
