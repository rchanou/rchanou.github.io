...
<div class="mainBodyContent">
    ...
    @if(isset($giftCardOptions) && $giftCardOptions !== null)
        ...
        <div class="loginOptions collapse out centered" id="loginOptions_{{$giftCard['productId']}}">
            ...
            <button type="button" class="regularButton" data-toggle="collapse" data-target="#loginToAccount_{{$giftCard['productId']}}" onclick="$('#createAccount_{{$giftCard['productId']}}').collapse('hide')">{{$strings['str_loginToExistingAccount']}}</button>
