...
echo "<strong>Initial time stamp: </strong>" . $initialTimestamp . "<p/>";
...
$finalTimestamp = time();
echo "<strong>Final time stamp: </strong>" . $finalTimestamp . "<p/>";

$totalTime = $initialTimestamp - $finalTimestamp;

echo "<strong>Total time: </strong>" . $totalTime . "<p/>";
die();
