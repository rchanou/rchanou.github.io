...
require_once(__DIR__.'../../Utility/Convert.php'); // requires two back? why?
...
class CSEvents {
    ...
    /**
     * Constructs a new instance of the CSEvents class.
     *
     * The CSEvents constructor requires an instantiated CSDatabase class for injection,
