...
class DocAPIContainer {
    ...
    public static function getData() {
        ...
        $data['sections'][] = new DocEventReservationTypes();
        $data['sections'][] = new DocEventRounds();
        $data['sections'][] = new DocEvents();
        $data['sections'][] = new DocEventStatus();
        $data['sections'][] = new DocEventTasks();
        $data['sections'][] = new DocEventTaskTypes();
        ...
        $data['sections'][] = new DocMemberships();
        $data['sections'][] = new DocMembershipTypes();
        $data['sections'][] = new DocOmnipay();
