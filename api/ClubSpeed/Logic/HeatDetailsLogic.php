 ...
 */
class HeatDetailsLogic extends BaseLogic {

    /**
     * Constructs a new instance of the HeatDetailsLogic class.
     *
     * The HeatDetailsLogic constructor requires an instantiated DbService class for injection,
    ...
    public function __construct(&$logic, &$db) {
        ...
        $this->interface = $this->db->heatDetails;
