...
class EventReservationsLogic extends BaseLogic {

    /**
     * Constructs a new instance of the EventReservationsLogic class.
     *
     * The EventReservationsLogic constructor requires an instantiated DbService class for injection,
