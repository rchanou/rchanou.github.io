...
//         if (!$definition instanceof \ReflectionClass || !$definition->isInstance(\ClubSpeed\Database\Records\BaseRecord)) {
...
//         $select = \ClubSpeed\Database\Helpers\SqlBuilder::buildSelect($this->record);
...
//         $update = \ClubSpeed\Database\Helpers\SqlBuilder::buildUpdate($this->record);
//         return $this;
//     }
