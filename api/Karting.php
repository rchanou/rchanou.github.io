...
<html lang="en">
  ...
  <body data-spy="scroll" data-target="#sidebar">
    <div class="jumbotron" id="main-header">
      <div class="container">
          <h1>Club Speed API<h1>
          <p>Welcome! If you come up with a cool use of this data, <a href="mailto:support@clubspeed.com">drop me a line</a> and brag about it!</p>
      ...
      <div class="row">
        ...
        <div class="col-xs-9">
          ...
          <div class="row">
            ...
            <div class="col-xs-6">
              <h4><i class="glyphicon glyphicon-asterisk"></i> Caching</h4>
              <p>Currently, no requests are cached. </p>
            </div><!--/span-->
            <div class="col-xs-6">
              <h4><i class="glyphicon glyphicon-asterisk"></i> Rate Limiting</h4>
              <p>The API is not currently rate limited. Please use good judgment when designing your application.</p>
            </div><!--/span-->
          </div><!--/row-->
		  <div class="row">
            <div class="col-xs-6">
              <h4><i class="glyphicon glyphicon-asterisk"></i> Output Formats</h4>
              <p>We currently support JSON, JSONP &amp; XML (plus iCal on Events).</p>
            </div><!--/span-->
            <div class="col-xs-6">
              <h4><i class="glyphicon glyphicon-asterisk"></i> Questions/Requests</h4>
              <p><a href="mailto:support@clubspeed.com">Email us</a> with any API questions or requests.</p>
            </div><!--/span-->
          </div><!--/row-->
          <div class="row">
            <div class="col-xs-6">
                <h4><i class="glyphicon glyphicon-lock"></i> Private Access</h4>
                <p>This icon represents a private call. When making a private call, either the private api key or an administrator username and password is required.</p>
            </div>
          </div>
		  <div class="header">
          ...
          <div class="row">
            ...
            <div class="span8">
                    <h4><i class="glyphicon glyphicon-plus"></i> Racers</h4>
                    <p class="description">
                    ...
                    <h4><i class="glyphicon glyphicon-plus"></i> Races - Race Results</h4>
                    ...
                    <ul>
                        ...
                        <li><strong>Upcoming Heat Types (for Web):</strong> <code>/races/upcoming_heat_types</code> (<a href="index.php/races/upcoming_heat_types.json?key=$daily_key">JSON</a>, <a href="index.php/races/upcoming_heat_types.js?key=$daily_key&callback=myCallback">JSONP</a>, <a href="index.php/races/upcoming_heat_types.xml?key=$daily_key">XML</a>)</li>
                    </ul>
                
                    <h4><i class="glyphicon glyphicon-plus"></i> Races - Scoreboard</h4>
                    ...
                    <h4><i class="glyphicon glyphicon-plus"></i> Races - Stats</h4>
                    ...
                    <h4><i class="glyphicon glyphicon-plus"></i> Races - After specific time</h4>
                    ...
                    <h4><i class="glyphicon glyphicon-plus"></i> Races - Final positions</h4>
                    ...
                    <h4><i class="glyphicon glyphicon-plus"></i> Races - Fastest Laps</h4>
                    ...
                    <h4><i class="glyphicon glyphicon-plus"></i> Tracks</h4>
                    ...
                    <h4><i class="glyphicon glyphicon-plus"></i> Version</h4>
                    ...
                    <h4><i class="glyphicon glyphicon-plus"></i> Channel</h4>
                    ...
                    <h4><i class="glyphicon glyphicon-plus"></i> Users</h4>
                    ...
                    <h4><i class="glyphicon glyphicon-plus"></i> Translations</h4>
                    ...
                    <h4><i class="glyphicon glyphicon-plus"></i> Settings</h4>
                    ...
                    <ul>
                     ...
                     <h4><i class="glyphicon glyphicon-plus"></i> Settings - Images</h4>
                    ...
                    <div class="call-group" id="queues">
                        <div class="row call-header background-header rounded">
                            <div class="col-xs-12">
                                <h2><i class="glyphicon glyphicon-chevron-right"></i> Queues <i class="glyphicon glyphicon-lock"></i></h2>
                            </div>
                        </div>
                        <div class="call-section">
                            <div class="row background-even" id="queues-event">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h3><span class="glyphicon glyphicon-plus"></span> Add to Event Queue</h3>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-10 col-xs-offset-1">
                                            <div>
                                                <button class="btn btn-warning">
                                                    <span class="glyphicon glyphicon-export"></span> POST /queues
                                                </button>
                                            </div>
                                            <div>
<pre class="prettyprint">
POST http://localhost/clubspeed/api/index.php/queues?debug=1 HTTP/1.1
Content-Length: 43
Authorization: Basic ZHZsc2c6c29tZXBhc3N3b3Jk
{
  "customerId": 1000004,
  "eventId": 1
}
                                    ...
                                    <div class="row">
                                        <div class="col-xs-10 col-xs-offset-1">
                                            <button class="btn btn-info">
                                                <span class="glyphicon glyphicon-save"></span> RESPONSE
                                            </button>
                                            <div>
<pre class="prettyprint">
HTTP/1.1 200 OK
Date: Wed, 03 Sep 2014 23:54:19 GMT
Content-Length: 0
Content-Type: text/html
                        ...
                        <div class="call-section">
                            <div class="row background-odd" id="queues-standard">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h3><span class="glyphicon glyphicon-plus"></span> Add to Standard Queue</h3>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-10 col-xs-offset-1">
...
<pre class="prettyprint">
HTTP/1.1 200 OK
Date: Wed, 03 Sep 2014 23:56:55 GMT
Content-Length: 0
Content-Type: text/html
</pre>
                                            </div>
                    ...
                    <!-- onine booking section -->

                    <div class="call-group" id="booking">
                        <div class="row call-header background-header rounded">
                            <div class="col-xs-12">
                                <h2><i class="glyphicon glyphicon-chevron-right"></i> Booking <i class="glyphicon glyphicon-lock"></i></h2>
                            </div>
                        </div>
                        <div class="call-section" id="booking-calls">
                            <div class="row background-even" id="booking-create">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h3><span class="glyphicon glyphicon-plus"></span> Create</h3>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-10 col-xs-offset-1">
                                            <div>
                                                <button class="btn btn-warning">
                                                    <span class="glyphicon glyphicon-export"></span> POST /booking
                                                </button>
                                            </div>
                                            <div>
<pre class="prettyprint">
...
Content-Length: 61
Authorization: Basic c3VwcG9ydDpjMGQzcmVk
{
    "heatId": 2,
    "productsId": 8,
    "quantityTotal": 5
...
<pre class="prettyprint">
HTTP/1.1 200 OK
Date: Wed, 03 Sep 2014 22:11:20 GMT
Content-Length: 27
Content-Type: application/json
{
    "onlineBookingsId": 1
                            ...
                            <div class="row background-odd" id="booking-list">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h3><span class="glyphicon glyphicon-th-list"></span> List</h3>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-10 col-xs-offset-1">
                                            <div>
                                                <button class="btn btn-success">
                                                    <span class="glyphicon glyphicon-export"></span> GET /booking
                                                </button>
                                            </div>
                                            <div>
<pre class="prettyprint">
GET http://{$_SERVER['SERVER_NAME']}/api/index.php/booking HTTP/1.1
Authorization: Basic c3VwcG9ydDpjMGQzcmVk
...
<pre class="prettyprint">
HTTP/1.1 200 OK
Date: Wed, 03 Sep 2014 22:19:11 GMT
Content-Length: 743
Content-Type: application/json
{
  "bookings": [
    {
      ...
      "heatSpotsAvailableCombined": 12,
      "heatSpotsAvailableOnline": 8,
      "products": [
        {
          "onlineBookingsId": 1,
          "productsId": 8,
        ...
        },
        {
          ...
          "productSpotsTotal": 3
                            ...
                            <div class="row background-even" id="booking-single">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h3><span class="glyphicon glyphicon-save"></span> Single</h3>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-10 col-xs-offset-1">
                                            <div>
                                                <button class="btn btn-success">
                                                    <span class="glyphicon glyphicon-export"></span> GET /booking/:id
                                                </button>
                                            </div>
                                            <div>
<pre class="prettyprint">
GET http://{$_SERVER['SERVER_NAME']}/api/index.php/booking/1 HTTP/1.1
Authorization: Basic c3VwcG9ydDpjMGQzcmVk
Accept-Language: en-US,en;q=0.8
</pre>
                                            </div>
...
<pre class="prettyprint">
HTTP/1.1 200 OK
Date: Wed, 03 Sep 2014 22:23:03 GMT
Content-Length: 514
Content-Type: application/json
{
  "bookings": [
      ...
      "products": [
        {
          ...
          "productSpotsTotal": 5
                            ...
                            <div class="row background-odd" id="booking-match">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h3><span class="glyphicon glyphicon-search"></span> Match</h3>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-10 col-xs-offset-1">
                                            <div>
                                                <button class="btn btn-success">
                                                    <span class="glyphicon glyphicon-export"></span> GET /booking?price=15
                                                </button>
                                            </div>
                                            <div>
<pre class="prettyprint">
GET http://{$_SERVER['SERVER_NAME']}/api/index.php/booking?quantityTotal=3 HTTP/1.1
Authorization: Basic c3VwcG9ydDpjMGQzcmVk
Accept-Language: en-US,en;q=0.8
</pre>
                                            </div>
...
<pre class="prettyprint">
HTTP/1.1 200 OK
Date: Wed, 03 Sep 2014 22:25:54 GMT
Content-Length: 743
Content-Type: application/json
{
  "bookings": [
      ...
      "products": [
        ...
        },
        {
          ...
          "productSpotsTotal": 3
                            ...
                            <div class="row background-even" id="booking-update">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h3><span class="glyphicon glyphicon-pencil"></span> Update</h3>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-xs-10 col-xs-offset-1">
                                            <div>
                                                <button class="btn btn-primary">
                                                    <span class="glyphicon glyphicon-export"></span> PUT /booking/:id
                                                </button>
                                            </div>
                                            <div>
<pre class="prettyprint">
PUT http://{$_SERVER['SERVER_NAME']}/api/index.php/booking/1 HTTP/1.1
Content-Length: 27
Authorization: Basic c3VwcG9ydDpjMGQzcmVk
{
    "quantityTotal": 12
...
<pre class="prettyprint">
HTTP/1.1 200 OK
Date: Wed, 03 Sep 2014 22:28:56 GMT
Content-Length: 0
Content-Type: text/html
</pre>
                                            </div>
                            ...
                            <div class="row background-odd" id="booking-delete">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h3><span class="glyphicon glyphicon-remove"></span> Delete</h3>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-xs-10 col-xs-offset-1">
                                            <div>
                                                <button class="btn btn-danger">
                                                    <span class="glyphicon glyphicon-export"></span> DELETE /booking/:id
                                                </button>
                                            </div>
                                            <div>
<pre class="prettyprint">
DELETE http://{$_SERVER['SERVER_NAME']}/api/index.php/booking/1 HTTP/1.1
Content-Length: 0
Authorization: Basic c3VwcG9ydDpjMGQzcmVk
...
<pre class="prettyprint">
HTTP/1.1 200 OK
Date: Wed, 03 Sep 2014 22:31:52 GMT
Content-Length: 0
Content-Type: text/html
</pre>
                                            </div>
                    ...
                    <!-- onine booking reservations section -->

                    <div class="call-group" id="reservations">
                        <div class="row call-header background-header rounded">
                            <div class="col-xs-12">
                                <h2><i class="glyphicon glyphicon-chevron-right"></i> Reservations <i class="glyphicon glyphicon-lock"></i></h2>
                            </div>
                        </div>
                        <div class="call-section">
                            <div class="row background-even" id="reservations-create">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h3><span class="glyphicon glyphicon-plus"></span> Create</h3>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-10 col-xs-offset-1">
                                            <div>
                                                <button class="btn btn-warning">
                                                    <span class="glyphicon glyphicon-export"></span> POST /reservations
                                                </button>
                                            </div>
                                            <div>
<pre class="prettyprint">
POST http://localhost/clubspeed/api/index.php/reservations HTTP/1.1
Content-Length: 79
Authorization: Basic c3VwcG9ydDpjMGQzcmVk
{
    "onlineBookingsId": 1,
...
<pre class="prettyprint">
HTTP/1.1 200 OK
Date: Wed, 03 Sep 2014 23:14:06 GMT
Content-Length: 38
Content-Type: application/json
{
  "onlineBookingReservationsId": 1
}
</pre>
                                            </div>
                                        </div>
                            ...
                            <div class="row background-odd" id="reservations-list">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h3><span class="glyphicon glyphicon-th-list"></span> List</h3>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-10 col-xs-offset-1">
                                            <div>
                                                <button class="btn btn-success">
                                                    <span class="glyphicon glyphicon-export"></span> GET /reservations
                                                </button>
                                            </div>
                                            <div>
<pre class="prettyprint">
GET http://localhost/clubspeed/api/index.php/reservations HTTP/1.1
Authorization: Basic c3VwcG9ydDpjMGQzcmVk
Accept-Language: en-US,en;q=0.8
</pre>
                                            </div>
...
<pre class="prettyprint">
HTTP/1.1 200 OK
Date: Wed, 03 Sep 2014 23:15:54 GMT
Content-Length: 556
Content-Type: application/json
{
  "reservations": [
    {
      ...
      "sessionId": "my_session_id",
      "quantity": 5,
      "createdAt": "2014-09-03 16:14:06.8759956",
      "expiresAt": "2014-09-03 16:44:06.8759956"
    },
    {
      "onlineBookingReservationsId": 2,
      "onlineBookingsId": 2,
      "customersId": 1000002,
      "sessionId": "my_session_id",
      "quantity": 2,
      "createdAt": "2014-09-03 16:15:52.3030257",
      "expiresAt": "2014-09-03 16:45:52.3030257"
    }
  ]
}
</pre>
                            ...
                            <div class="row background-even" id="reservations-single">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h3><span class="glyphicon glyphicon-save"></span> Single</h3>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-10 col-xs-offset-1">
                                            <div>
                                                <button class="btn btn-success">
                                                    <span class="glyphicon glyphicon-export"></span> GET /reservations/:id
                                                </button>
                                            </div>
                                            <div>
<pre class="prettyprint">
GET http://localhost/clubspeed/api/index.php/reservations/1 HTTP/1.1
Authorization: Basic c3VwcG9ydDpjMGQzcmVk
Accept-Language: en-US,en;q=0.8
</pre>
                                            </div>
...
<pre class="prettyprint">
HTTP/1.1 200 OK
Date: Wed, 03 Sep 2014 23:18:59 GMT
Content-Length: 291
Content-Type: application/json
{
  "reservations": [
    {
      ...
      "expiresAt": "2014-09-03 16:44:06.8759956"
                            ...
                            <div class="row background-odd" id="reservations-match">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h3><span class="glyphicon glyphicon-search"></span> Match</h3>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-10 col-xs-offset-1">
                                            <div>
                                                <button class="btn btn-success">
                                                    <span class="glyphicon glyphicon-export"></span> GET /reservations?quantity=5
                                                </button>
                                            </div>
                                            <div>
<pre class="prettyprint">
GET http://localhost/clubspeed/api/index.php/reservations?quantity=5 HTTP/1.1
Authorization: Basic c3VwcG9ydDpjMGQzcmVk
Accept-Language: en-US,en;q=0.8
</pre>
                                            </div>
...
<pre class="prettyprint">
HTTP/1.1 200 OK
Date: Wed, 03 Sep 2014 23:23:23 GMT
Content-Length: 291
Content-Type: application/json
{
  "reservations": [
    {
      ...
      "expiresAt": "2014-09-03 16:44:06.8759956"
                            ...
                            <div class="row background-even" id="reservations-update">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h3><span class="glyphicon glyphicon-pencil"></span> Update</h3>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-10 col-xs-offset-1">
                                            <div>
                                                <button class="btn btn-primary">
                                                    <span class="glyphicon glyphicon-export"></span> PUT /reservations/:id
                                                </button>
                                            </div>
                                            <div>
<pre class="prettyprint">
PUT http://localhost/clubspeed/api/index.php/reservations/1 HTTP/1.1
Authorization: Basic c3VwcG9ydDpjMGQzcmVk
Content-Length: 21
Accept-Language: en-US,en;q=0.8
{
...
<pre class="prettyprint">
HTTP/1.1 200 OK
Date: Wed, 03 Sep 2014 23:25:14 GMT
Content-Length: 0
Content-Type: text/html
</pre>
                                            </div>
                            ...
                            <div class="row background-odd" id="reservations-delete">
                                <div class="col-xs-12">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <h3><span class="glyphicon glyphicon-remove"></span> Delete</h3>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-10 col-xs-offset-1">
                                            <div>
                                                <button class="btn btn-danger">
                                                    <span class="glyphicon glyphicon-export"></span> DELETE /reservations/:id
                                                </button>
                                            </div>
                                            <div>
<pre class="prettyprint">
DELETE http://localhost/clubspeed/api/index.php/reservations/2 HTTP/1.1
Content-Length: 0
Authorization: Basic c3VwcG9ydDpjMGQzcmVk
Accept-Language: en-US,en;q=0.8
</pre>
...
Content-Type: text/html
        ...
        <div class="col-xs-3">
            <div class="affix" id="sidebar">
              <ul class="nav">
              <li class="nav-group">
                    <a class="nav-group-header" href="#queues">Queues</a>
                    <ul class="nav">
                        <li class="nav-group-item"><a href="#queues-event">Add to Event</a></li>
                        <li class="nav-group-item"><a href="#queues-standard">Add To Standard</a></li>
                    </ul>
                </li>
                <li class="nav-group">
                    <a class="nav-group-header" href="#booking">Booking</a>
                    <ul class="nav">
                        <li class="nav-group-item"><a href="#booking-create">Create</a></li>
                        <li class="nav-group-item"><a href="#booking-list">List</a></li>
                        <li class="nav-group-item"><a href="#booking-single">Single</a></li>
                        <li class="nav-group-item"><a href="#booking-match">Match</a></li>
                        <li class="nav-group-item"><a href="#booking-update">Update</a></li>
                        <li class="nav-group-item"><a href="#booking-delete">Delete</a></li>
                    </ul>
                </li>
                <li class="nav-group">
                    <a class="nav-group-header" href="#reservations">Reservations</a>
                    <ul class="nav">
                        <li class="nav-group-item"><a href="#reservations-create">Create</a></li>
                        <li class="nav-group-item"><a href="#reservations-list">List</a></li>
                        <li class="nav-group-item"><a href="#reservations-single">Single</a></li>
                        <li class="nav-group-item"><a href="#reservations-match">Match</a></li>
                        <li class="nav-group-item"><a href="#reservations-update">Update</a></li>
                        <li class="nav-group-item"><a href="#reservations-delete">Delete</a></li>
                    </ul>
                </li>
              </ul>
    ...
    <script src="js/karting.js"></script>
  </body>
</html>
EOH;
		die($html);
