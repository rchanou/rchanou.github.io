    ...
    z.deepCopy = function(origSource) {
        ...
        function _deepCopy(source) {
            ...
            switch (z.getType(source)) {
                case z.types.object:
                    if (z.check.exists(source.prototype)) {
                        return _singleCopy(source, Object.create(source.prototype));
                    }
                    else {
        ...
        */
        function Cache(options) {
            ...
            var set = function(key, value) {
                ...
                _cache[key] = z.deepCopy(value);
                return _cache[key];

                var v = z.deepCopy(value);
                _cache[key] = {
                    data: v,
                    args: null,
                    getter: null,
            ...
            */
            return (function(cache) {
                ...
                z.defineProperty(cache, "get", { get: function() { return get; }, writeable: false });
                z.defineProperty(cache, "set", { get: function() { return set; }, writeable: false });
                return cache;
            })(accessor);
        }
